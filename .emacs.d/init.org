...
how headings with special bullets instead o asterisks.

+begin_src emacs-lisp
 (use-package org-bullets :defer)
+end_src

hange title and heading sizes.

ODO: move non-visuals to separate hook
+begin_src emacs-lisp
...
hether to hide or not symbols for emphasis like ~a~, *b*, /c/...

+begin_src emacs-lisp
 (setq org-hide-emphasis-markers t)
+end_src

eplace ~-~ by ~•~ on unordered lists.
